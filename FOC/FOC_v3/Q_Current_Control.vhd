-- -------------------------------------------------------------
-- 
-- File Name: foc_hdl_prj_v3\hdlsrc\FOC_Modified_v3\Q_Current_Control.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: Q_Current_Control
-- Source Path: FOC_Modified_v3/DQ_Current_Control/Q_Current_Control
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
END Q_Current_Control;


ARCHITECTURE rtl OF Q_Current_Control IS

  -- Component Declarations
  COMPONENT Saturate_Output_block
  ...
  FOR ALL : Saturate_Output_block
    USE ENTITY work.Saturate_Output_block(rtl);
  ...
  SIGNAL currentControlPTerm              : signed(31 DOWNTO 0);  -- sfix32_En19
  SIGNAL currentControlPTerm_1            : signed(31 DOWNTO 0);  -- sfix32_En19
...
BEGIN
  ...
  -- <S9>/Saturate_Output
  u_Saturate_Output : Saturate_Output_block
  ...
  -- <S9>/Product2
  currentControlPTerm <= paramCurrentControlP_1 * currentControlError_1;

  PipelineRegister2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '0' THEN
        currentControlPTerm_1 <= to_signed(0, 32);
      ELSIF enb = '1' THEN
        currentControlPTerm_1 <= currentControlPTerm;
      END IF;
    END IF;
  ...
  -- <S9>/Add1
  Add1_add_cast <= resize(currentControlPTerm_1 & '0' & '0' & '0' & '0' & '0' & '0' & '0' & '0', 41);
